...
// After checking the data in the file, re-print people whose organization is gachon university by using the linked list
...
{
	struct NODE* ptr = head->next;
	char organization[20] = "Gachon University";
	int found = 0;
	while (ptr)
	{
